    ...
    render() {
        ...
        return (
            <div className="user-redux-container">
                <div className='title'>Hỏi dân IT</div>
                    ...
                    <div className='container'>
                        <div className="row">
                            ...
                            <div className='col-3'>
                                ...
                                <input disabled={this.state.action === CRUD_ACTION.EDIT ? true : false} className='form-control' type='email' value={email} onChange={(event) => { this.onChangeInput(event, 'email') }} />
                            </div>
                            <div className='col-3'>
                                <label><FormattedMessage id="manage-user.password" /></label>
                                <input disabled={this.state.action === CRUD_ACTION.EDIT ? true : false} className='form-control' type='password'
